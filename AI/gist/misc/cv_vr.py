...
def find_matches(des_model, des_scene, min_matches=15, verbose=1, kp_model=None, kp_scene=None,
                 model=None, scene=None):
...
matches = find_matches(des_model, des_scene, min_matches=MIN_MATCHES, 
                       kp_model=kp_model, kp_scene=kp_scene,
